...
namespace _10_Search_Y_Share_Contract_DESDE_CERO.Views
{
    /// <summary>
    /// Página básica que proporciona características comunes a la mayoría de las aplicaciones.
    /// </summary>
    public sealed partial class DataPage : _10_Search_Y_Share_Contract_DESDE_CERO.Common.LayoutAwarePage
    {
        public DataPage()
        {
